...
//
    public int heuristicValue(BoardGame node) {
        return node.killedStonesCount;


    }
    public int numberOfStones(BoardGame child) {
        int stonesRemaining =4- child.playerStones.length ;
